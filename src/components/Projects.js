    ...
    return(
      <section className="resume-section p-3 p-lg-5 d-flex flex-column" id="projects">
        <div className="my-auto">
          ...
          <Experience title="MyProfile / Portfolio Website (ReactJS, AWS)" description="Built a mobile friendly website, that runs on node server. It features my work-timeline, projects & interests. It is deployed on AWS utilizing features like VPC, Load balancers and Auto-scaling." />
