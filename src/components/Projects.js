    ...
    return(
      <section className="resume-section p-3 p-lg-5 d-flex flex-column" id="projects">
        <div className="my-auto">
          ...
          <Experience title="MyProfile / Portfolio Website (ReactJS, NodeJS, Firebase)" description="Built a mobile friendly website using React JS. It features my work-timeline, projects & interests. Also hosted on Firebase." />
