              ...
              <div className="container-fluid p-0">
                ...
                <section className="resume-section p-3 p-lg-5 d-flex flex-column" id="experience">
                  <div className="my-auto">
                    ...
                    <Experience title="Software Engineer Intern" companyName="Home Slice" description="Built a new user-facing features website using React JS for HomeSlice customers. Used GraphQL to build API’s.
Responsible for building reusable React components and Redux forms. Also, translated wireframes into high quality code." time="June 2017 to October 2017" />
                    <Experience title="Software Engineer Intern" companyName="Technology for Impact - Refugee Transitions" description="Developed a Salesforce web portal for volunteers of Refugee Transitions using Visualforce and Salesforce Apex.
